...
function encode_jwt(secret_1, id_1, payload_1) {
    return __awaiter(this, arguments, void 0, function* (secret, id, payload, ttl = 3600, options = {}) {
        const header = {
            alg: 'HS256',
            typ: 'JWT',
        };
        ...
        const signature = yield utils.createSignature(encodedHeader, encodedPayload, secret);
...
function decode_jwt(secret, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const expectedSignature = yield utils.createSignature(encodedHeader, encodedPayload, secret);
...
function validate_jwt(secret, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const payload = yield decode_jwt(secret, token);
